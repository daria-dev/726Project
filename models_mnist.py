...
class FaderNetwork(nn.Module):
  def __init__(self):
    ...
    #     nn.ConvTranspose2d(512+10, 512, 4, 2, 1, bias=False),
    #     nn.ReLU()
    #     )
    # self.conv2 = nn.Sequential(
    #     nn.ConvTranspose2d(512+10, 256, 4, 2, 1, bias=False),
    #     nn.ReLU()
    #     )
    # self.conv3 = nn.Sequential(
    #     nn.ConvTranspose2d(256+10, 128, 4, 2, 1, bias=False),
    #     nn.ReLU()
    #     )
    ...
    self.conv6 = nn.Sequential(
        nn.ConvTranspose2d(64+10, 16, 3, 2, 1, 1, bias=False),
        nn.ReLU()
        )
    self.conv7 = nn.Sequential(
        nn.ConvTranspose2d(16+10, 1, 3, 2, 1,1, bias=False),
        nn.ReLU()
        )
  ...
  def decode_prob(self, z_s, hot_labels,skip1,skip2,skip3):
    ...
    hot_labels = torch.cat([hot_labels, hot_labels[:,:,:3,:]], dim=2)
    hot_labels = torch.cat([hot_labels, hot_labels[:,:,:,:3]], dim=3)
